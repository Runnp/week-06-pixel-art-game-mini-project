...
# ── UNLOCK TRIGGERS — add these calls throughout the game ────
#
# In npc_bibi.gd _on_interact():
#   Codex.unlock("bibi_profile")
#   Codex.unlock("salt_dust")
#
# In npc_kamola.gd _on_interact():
#   Codex.unlock("kamola_profile")
#
# In npc_malik.gd _on_interact():
#   Codex.unlock("malik_profile")
#
# In npc_fisherman.gd _on_interact():
#   Codex.unlock("fisherman_profile")
#
# In tree_spot.gd plant():
#   Codex.unlock("saxaul_tree")
#   if GameManager.trees_planted == 1:
#     Codex.unlock("plant_first_tree") — handled via chapter signal
#
# In aquarium.gd _add_fish():
#   Codex.unlock("fish_ecology")
#   Codex.unlock("add_fish_aquarium")
#
# In prop_interact.gd for water level marker:
#   Codex.unlock("interact_water_marker")
#
# In soil_patch.gd _play_spray_effect():
#   Codex.unlock("first_spray")
#
# In npc_zorin.gd _zorin_considers():
#   Codex.unlock("zorin_profile")
#
# ── ADD TO AUTOLOADS ──────────────────────────────────────────
# Project > Project Settings > Autoload
# res://scripts/systems/codex.gd    Name: Codex
